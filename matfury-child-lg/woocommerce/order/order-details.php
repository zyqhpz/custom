...
<?php if ($order->get_payment_method_title() == 'JomPay' && $order->get_status() == 'on-hold') { ?>
	<?php
	$jompay = new Jompay();
	$rrn = new RRN();
	...
	?>
	<div class="jompay-bill">
		<img style='width: 90px; height: 90px; margin: 10px;' src='https://www.jompay.com.my/img/logo.png'>
		<div class="jompay-details">
			<div class="jompay-info">
				<h4>
					<b>Biller Code: </b>
				...
				<h4>
					...
					<input id="ref-1" type="text" value="<?php echo $sRRN;?>" hidden>
				</h4>
			</div>
		</div>
...
<?php } ?>
	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
		...
		<tbody>
			...
			add_action( 'woocommerce_jompay_bill', $order );
			?>
		</tbody>
