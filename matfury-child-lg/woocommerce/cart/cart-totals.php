...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
        ...
        <!-- ADD NEW HERE (Haziq - 07/02/2022) - hide the shipping option details -->
		...
		<tr class="order-total">
            ...
            <!-- ADD NEW HERE (Haziq - 07/02/2022) - Change wc_cart_totals_order_total_html() to wc_cart_totals_subtotal_html(). This will only get the calculation before add the shipping fees-->
			<td data-title="<?php esc_attr_e( 'Total', 'martfury' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
