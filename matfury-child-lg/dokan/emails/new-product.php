...
<ul>
	...
	<!-- ADD NEW HERE (Haziq - 04/02/2022) - display UOM at new product email -->
    <li>
        <?php
            $woo_uom_output = get_post_meta( $data['product_id'], '_woo_uom_input', true );
