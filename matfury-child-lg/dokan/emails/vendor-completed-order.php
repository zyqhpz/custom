    ...
    <table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
        <thead>
            <tr>
				...
				<!-- ADD NEW HERE (Haziq - 05/02/2022) - add uom column --> 
        ...
        <tfoot>
            ...
            if ( $item_totals ) {
                ...
                foreach ( $item_totals as $total ) {
                    ...
                    ?>
                    <tr>
                        <!-- ADD NEW HERE (Haziq - 04/02/2022) - change colspan="2" to colspan="3" -->
            ...
            if ( $order->get_customer_note() ) {
                ...
                <tr>
                    <!-- ADD NEW HERE (Haziq - 04/02/2022) - change colspan="2" to colspan="3" -->
                    <th class="td" scope="row" colspan="3" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Note:', 'dokan-lite' ); ?></th>
